...
.setColor("#9B59B6")
.addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/4yfvhKR**")
...
if(message.content.startsWith(! + 'trans')) {
        ...
        if (isNaN(args[0])) {
            ...
            if (!defineduser) return message.channel.send(`**Usage: ${!}trans @someone amount**`);
            var mentionned = message.mentions.users.first();
...
client.login("NTAyNTYwMTYxMzY2Mjc4MTY1.DqptwQ.vR7CZkDacc5pappsxl19XuUNF8I");